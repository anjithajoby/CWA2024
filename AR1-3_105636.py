...
def predict_mood1(mood):
    df = pd.DataFrame([[mood, mood, mood]],
                    columns=['light_min', 'light_max', 'light_mean'])
    return model.predict(df)[0]
# Training the model
...
phonelight = round(predict_mood1(phoneanxiety_wellbeing))  # Example values
print("The amount of blue light the user receives is ", phonelight)
phonelight = interpret_mood(phoneanxiety_wellbeing,1)
print(phonelight)
...
mentalhealth = round(predict_mood1(mental_wellbeing))  # Example values
print("The amount of time the user spends to theirself is ", mentalhealth)
mentalhealth = interpret_mood(mental_wellbeing,2)
print(mentalhealth)
...
sleep = round(predict_mood1(sleep_wellbeing))  # Example values
print("The score mood is", round(sleep))
sleep = interpret_mood(sleep_wellbeing,3)
print(sleep)
